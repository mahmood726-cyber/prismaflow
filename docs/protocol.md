        # Prismaflow: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/prismaflow.git

        ## Objective

        PRISMAFlow generates publication-ready PRISMA 2020 flow diagrams from structured screening data, with support for database-specific breakdowns and grey literature.
        ...
        - Code: https://github.com/mahmood726-cyber/prismaflow.git
